...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var googleAPIKey = "AIzaSyBeef6ek-xyehw_KT1Vz5n4yd8qqY9don0"
    var googleURL: URL {
    ...
    func analyzeResults(_ dataToParse: Data) {
        ...
        DispatchQueue.main.async(execute: {
            ...
            if (errorObj.dictionaryValue != [:]) {
                ...
                guard logoAnnotations != JSON.null else { return }
                
                let logoDescription = logoAnnotations[0]["description"].description
                print(logoDescription)
                self.labelResults.text = logoDescription
